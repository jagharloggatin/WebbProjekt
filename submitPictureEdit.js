const formEditPicture = document.getElementById('formEditPicture');
const urlPost = 'http://localhost:3000/api/edit/picture';
const urlJson = 'app-data/library/picture-library.json';

formEditPicture.addEventListener('submit', async event => {
    event.preventDefault();
    //Create the key/value pairs used in the form
    const formData = new FormData(formEditPicture);
    try {
