const formEditAlbum = document.getElementById('formEditAlbum');
const urlPost = 'http://localhost:3000/api/edit/album';
const urlJson = 'app-data/library/picture-library.json';

formEditAlbum.addEventListener('submit', async event => {
